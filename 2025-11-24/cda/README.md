...
| **Lines Removed** (➖) | 1405                                        |
| **Net Change** (↕)    | 12886                |
| **Active Time** (⌚)   | 551 minutes |


## Modified Files
- **Home.tsx** (+1301, -312)
- **settings.json** (+59, -0)
- **ShowPastEventsToggle.tsx** (+60, -12)
- **index.ts** (+4, -0)
...
- **SearchHeadingText.tsx** (+131, -2)
- **MyEvents.test.tsx** (+165, -3)
...
> **Last Updated:** 24/11/2025, 20:19:34